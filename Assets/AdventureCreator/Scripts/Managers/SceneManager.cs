...
namespace AC
{
	...
	public class SceneManager : ScriptableObject
	{
		...
		public void InitialiseObjects (bool createFolders = true)
		{
			...
			// Assign Player Start
			if (KickStarter.settingsManager != null && KickStarter.settingsManager.movementMethod == MovementMethod.None && KickStarter.settingsManager.GetDefaultPlayer (false) == null)
			{}
			else if (KickStarter.sceneSettings && KickStarter.sceneSettings.defaultPlayerStart == null)
			{
